...
method = 'mag';
sm_type = 'cosine'; % euclidean, cityblock, cosine
...
if strcmp(sm_type, 'cosine') == 1 % take maximum cosine distance
    [max_sim max_gallery_index] = max(SM);
elseif strcmp(sm_type, 'euclidean') == 1 || strcmp(sm_type, 'cityblock') == 1% take minimum eucliean/cityblock distance
